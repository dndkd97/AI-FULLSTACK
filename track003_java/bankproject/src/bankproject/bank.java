	...
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in);
		 ...
		 if(num ==1 ) {
			     ...
			     System.out.println("비밀번호 입력"); pw = sc.next().charAt(0);
			      {
			              if( id == pw &&age>0) {System.out.println("==계좌조회");
			 ...
			 System.out.println("아이디 입력"); id = sc.next().charAt(0);
			 System.out.println("비밀번호 입력"); pw = sc.next().charAt(0);
			 if (id ==pw && age>0) {System.out.println("입금:"); money += sc.nextInt();}
			 else {System.out.println("다시 확인해주세요");}}
		 else if(num==4 ){
			 System.out.println("출금기능입니다");
			 System.out.println("아이디 입력"); id = sc.next().charAt(0);
			 System.out.println("비밀번호 입력"); pw = sc.next().charAt(0);
			 if (id ==pw && age>0) {System.out.println("출금:"); money -= sc.nextInt();}
			 else {System.out.println("다시 확인해주세요");}}
		 else if(num==5 ){
...
//	for(;num==9;) {System.out.print("* 1.추가 "+"\n"+"* 2.조회" +"\n"+ "* 3.입금" + "\n"+"* 4.출금" +
//            "\n"+ "* 5.삭제 "+ "\n"+"* 9.종료"+ "\n"); num = sc.nextInt();}
