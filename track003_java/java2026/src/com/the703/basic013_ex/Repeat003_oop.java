...
public class Repeat002_oop {
	public static void main(String[] args) {
		...
		// :Papa p1 = - 1번지 {money=10 / toString} = 1번지 {money=10 / toString}/출력결과: Papa [money=10]
		...
		// : Son s2(2번지) = {money=150, car=2/@toString}-{money=10/toString}  , 출력결과:Son [money=150, car=2]
		...
		/ : Son 객체생성, 참조는 Papa / 출력결과 : Son [money=150, car=2] , 10
		...
		:System.out.println( ((Son)p4).money);
	     ...
	     Q8 오버로딩/오버라이딩이란?
        :-오버로딩  :메서드의 이름을 같게, 알규먼트 자료형과 갯수를 다르게 구분 / 비슷한 기능
         -오버라이딩:상속시 부모의 메서드를 자식에게 맞게 수정해서 사용
	}
}
