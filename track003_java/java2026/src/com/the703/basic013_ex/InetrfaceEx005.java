...
- show() 메서드로 주문 내역 출력
  ...
  각 메뉴의 eat() 호출*/
    ...
    System.out.println("1)햄버거 2)김치찌개");
    System.out.print("음식 주문>");int a1=sc.nextInt();
    ...
    void show() {
    	...
    	System.out.println("2026년 4월 28일");
    	
    	//Launch
    	}
    }

public class InetrfaceEx005 {
