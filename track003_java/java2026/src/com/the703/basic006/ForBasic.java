...
public class ForBasic {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n■step2) for");
		//for(;;){빠져나올조건}
		//step2-1) 반복되는 영역          System.out.print();
		...
		//패턴:시작2;종료8;변화1
		for(int i=2; i<=8; i++) {System.out.println(i);} System.out.println();
		
		//패턴:시작3;종료9;변화3
		for(int i=3; i<=9; i=i+3) {System.out.println(i);} System.out.println();
		
		//패턴:시작5;종료1;변화 -2
		for(int i=5; i>=1; i=i-2) {System.out.println(i);} System.out.println();
		...
		for(int i=1; i<=3; i++) {System.err.println("\nHi"+i);}
	}
