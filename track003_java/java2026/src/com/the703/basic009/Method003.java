...
public class Method003 {
	...
	//1.함수구조 public static 리턴값(결과물) 메서드명(마법상자 이름) (파라미터:재료) { 할일 }
	...
	public static void main(String[] args) {
		...
		System.out.println("2. 당신의 소개는?" + intro("홍길동",9)); // 2. 당신의 소개는? 홍길동님의 레벨은 9
		                 //public staticd String intro("홍길동",9){홍길동님의 레벨은 9}
		
		System.out.println("2. 당신의 소개?" + intro(sing(),10)); //용감한 자바전사님의 레벨은 10
		
		System.out.println("3. 반타작의 저주 > " + spell(9)); // 3. 반타작의 저주 > 4.5
		// public static double spell(int num){return a/2.0;}
