...
public class MethodEx003 {
	...
	public static float return_float() {return (float)10/3;}
	public static String mycolor() {return "PURPLE";}
	public static String jangsu() {return "★★★★★★★";}
	public static int myadd(int num, int num1) {return (num+num1);}
	public static String myban(char ch) {return "나는"+(ch=='A'?"노랑조":ch=='B'?"주황조":"");}
	public static String stdId(int num) {return "G"+num;}
	public static String stdAvg(int num) {return num>=90?"A":num>=80?"B":num>=70?"C":"D";}
