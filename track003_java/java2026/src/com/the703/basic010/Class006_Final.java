...
class FinalEx extends Object{
	static final String child = "5-5"; // 클래스 변수 - method area - new 상관X - 인스턴스상관X
	String name; //인스턴스 변수 - heap area - new 관련 o - 생성자() 관련 o - this
	void show() {System.out.println(child + "\t" + name);} //인스턴스 메서드
}
