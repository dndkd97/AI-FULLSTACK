...
class Car32  extends Object{  // 생성자는 초기화
	...
	public Car32() { color="white"; } // 기본생성자 - 2)생성자가 개발자 수동으로 만들때 자동생성취소
...
public class Class003 {
	public static void main(String[] args) {
         ...
         System.out.println(car1); // Car31@5305068a(번지)
...
■복습문제
1.oop?
:objact orients programming / 객체지향 프로그래밍 / 부품객체를 이용해서 완성된 프로그래밍을 만드는 기법
2.oop특징
:캡슐화,다형성,상속,추상화
