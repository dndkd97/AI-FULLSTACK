...
public class Chat001_Server {
	...
	System.out.println("[Server] 1. 서버준비완료 A/s 센터 OPEN....");}catch(IOException e ) {e.printStackTrace();}
...
////////////////////////////////////////////////////////////
//3) ★듣기 - InputStream > 프로그램 기준 > OutputStream -말하기
class Receiver extends Thread{
	...
	@Override public void run() { 
		...
		}catch(Exception e) { System.out.println("통신 마무리");}
		finally {
			try {
			if(    in!=null) {in.close();}
