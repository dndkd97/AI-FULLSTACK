...
class UserDto{
	...
	public static int getCnt() { return cnt; } public static void setCnt(int cnt) { UserDto.cnt = cnt; }
...
public class List002 {
	public static void main(String[] args) {
		...
		System.out.println("1.ger > "+users.get(0));
		...
		int cnt=0;
		for(UserDto user : users) {System.out.println("INFO" + (cnt++ +1)+":"+user.getNo()+"/"+user.getEmail());}
