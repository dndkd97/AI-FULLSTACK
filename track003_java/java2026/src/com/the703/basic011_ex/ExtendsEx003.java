...
class Son extends Papa{
	...
	//public Son(int moeny) { super(); this.moeny = moeny; } 바로 위에 파라미터 int brain 자료형 같음
	public Son(int brain,int moeny) { super(brain); this.moeny = moeny; }
...
[heap]                                        [stack]
       #3.Object()    {                 }#4.
       #2.Papa(148)   {brain=100 / sing }#5.
[1번지] #1.Son(148,100){money=148 / @sing}#6. ← myson[1번지]                    
                                               main
*/
