...
public class Lambda001 {
	public static void main(String[] args) {
		...
		//#2. 익명이너클래스(test 목적, 1번쓰고 버릴목적, 잘 안쓰는 이벤트)
		Inter1 i21 = new Inter1() {
    @Override public void method() {  System.out.println("hello :D :D"); } };i21.method();
		Inter1 i22 = new Inter1() {
    @Override public void method() {  System.out.println("hello :D :D"); } };i22.method();
		//#3. lambda
