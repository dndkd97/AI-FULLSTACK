...
public class Lambda002 {
	...
	public static void main(String[] args) {
		// interface InterA2{  void   hi(); }
		System.out.println("[SETP1]매개변수X,리턴값X");
		// 1-1. 익명개체
		...
		//interface InterB2{  void   hi(String name); }
		System.out.println("[SETP2]매개변수O,리턴값X");
		// 2-1. 익명개체 hi! sally
		...
		InterB2 b3 =(name)->{System.out.println("hi!"+name);}; b3.hi("young");
		InterB2 b4 =name->System.out.println("hi!"+name); b3.hi("뽀삐");
		
		//interface InterC2{  String hi(); }
		System.out.println("[SETP3]매개변수X,리턴값O");
		// 3-1. 익명개체 Good:Day
		...
		//interface InterD2{  String   hi(int num , String name); }
		System.out.println("[SETP4]매개변수O,리턴값O");
		// 4-1. 익명개체 hi sally
...
//			for(int i=0; i<num; i++) {star+="★";}
	...
	//	System.out.println(d3.hi(6, "sally"));
