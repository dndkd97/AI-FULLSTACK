...
<div class="alert alert-warning"> 반갑습니다 <%=session.getAttribute("email") %> 님</div>
<a href="jsp016_logout.jsp" class="btn btn-danger"> 로그아웃</a>
<%} %>
		<form action="jsp016_result.jsp"  method="post" onsubmit="return checkLogin()">
			...
			<div class="my-3"> 
				<button type="submit"    title="login 하러가기"
				       class="btn btn-danger" id="check"  name="check"> 로그인 </button> 
				       <!--  -->
			</div>								
		</form>
		<script>
