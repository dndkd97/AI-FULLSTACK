...
<body>
   <div class="container card my-5 p-3">
      <h3 class="card-header my-3">001. el</h3>
      ...
      <hr/>
      <h3 class="card-header my-3 ">002. jstl</h3>
      <pre class="alert bg-info-subtle">
      ...
      <h4 class="card-header">1>if</h4>
	   ...
	   <div class="container card my-5 p-3">
			<h4 class="card-header my-3">1) if</h4>
			<pre class="alert bg-dark-subtle">
			문제 설명:
			jstl if를 사용하여
			...
			<h4 class="card-header my-3">2) choose</h4>
			<pre class="alert bg-dark-subtle">
			문제 설명:
			변수 level을 3으로 설정하고,
			jstl choose문을 이용하여
			...
			<h4 class="card-header my-3">3) forEach</h4>
			<pre class="alert bg-dark-subtle">
			문제 설명:
