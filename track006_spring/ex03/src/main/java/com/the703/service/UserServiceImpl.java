...
public class UserServiceImpl implements UserService {
	...
	@Override public String findByEmail(String email) {  
		
			
		return dao.findByEmail(email); }
	@Override public AuthListDto readAuth(AuthDto dto) {  
		AuthListDto dto2 =dao.readAuth(dto); System.out.println("........  " + dto2);   return dto2; }
