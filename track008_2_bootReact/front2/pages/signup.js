...
//2. function (부품)
function SignupPage(){
    //5개 부품 - 감지 : useEffect(이벤트변경감지) , useState(변수) 
    ...
    // 데이터 받아서 회원가입전송 - 네트워크가 느리면 0.5초 2~3회 연속으로 클릭
    ...
    ////////////// Layout > Row > Col Col
    // 모바일 제일 작은 사이즈: 24 xs={} 모바일2: 16 sm={} 태블릿: 8 md={} / lg={}
    return (<Row justify="center">
      ...
      { !success && (
        ...
        {/* 이메일 입력 + 중복검사 Form.Item > Input / name , hasFeedback 아이콘 */}
        <Form.Item
            label="이메일"
            name="email"
            hasFeedback
