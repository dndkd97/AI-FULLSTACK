...
const authReducer=createSlice({
    ...
    reducers:{
        ...
        signupFailure : (state,action)=>{
            state.loading=false;
            state.error=action.payload; // 오류메세지
           // state.success=false;
        },
        ...
        loginSuccess : (state,action)=>{
            state.loading=false;
            state.user        = action.payload.user || null; // ## Map<String,Object> key        // user 로 수정
            state.accessToken = action.payload.accessToken || null; // ## Map<String,Object> key // accessToken으로 수정
            // boot에서 넘겨주는 값
        ...
        // ---유저 추가---  ResponseEntity<UserResponseDto>
...
export const {signupRequest,signupSuccess,signupFailure,resetUserState,
    loginRequest,loginSuccess,loginFailure,logoutRequest,logoutSuccess,logoutFailure,
