        ...
        <div style={{maxWidth:600 , margin: "40px auto"}}>
            <Card title="마이페이지(회원 정보)">
                ...
                <Descriptions title="User Info" bordered column={1}>
                    ...
                    {/* 프로필 이미지 수정 Q1. updateProfileImageRequest 호출*/}
...
// BEFORE
// 이 코드를 넣는 이유는 
// 서버 사이드 렌더링(SSR) 과정에서 Redux-Saga의 비동기 API 요청이 완료될 때까지 서버가 출력을 멈추고 기다리게 만들기 위해서입니다.
