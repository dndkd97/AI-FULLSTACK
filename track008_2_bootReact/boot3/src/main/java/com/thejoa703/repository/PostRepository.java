...
/*
(1) 사용할수 있는 기본 SQL
1. CREATE :save       : insert into app_user(컬럼) values(?,?,?,,)
2. READ   :findAll    : select * from app_user
		  :findById   : select * from app_user where id=?

3. UPDATE : save       : update app_user set 컬럼1=? where id=? 
4. DELETE : deleteById : delete from app_user where id=?
